...
export default class UserDashboardOffset extends BaseCommand<typeof UserDashboardOffset> {
  ...
  static flags: FlagInput = {
    ...
    numReadings3: Flags.integer({
      char: "k",
      description: "3 readings per day, 3.0 mmol/l",
      default: 0,
    }),
  ...
  public async run(): Promise<void> {
    ...
    const smbgLookup: Record<string, number> = {
      ...
      "3 reading per day, average 3.0 mmol/l": flags.numreadings3,
    ...
    const user = await Dashboard.createSMBGDashboardOffset(
      smbgLookup,
      periodLength,
      flags.offset,
      flags.patientName,
