...
// Data structure for the dataset upload
...
// Allow upload to accept either a single object or an array of objects
 ...
 */
export async function authenticateAndUploadData(
  creds: Credentials,
