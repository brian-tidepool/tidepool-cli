 ...
 * @returns The shifted JSON data
 */
export function shiftJsonTimes(data: unknown, timezoneOffsetHours: number = 0): unknown {
  if (!data) {
 ...
 */
function extractTimestamps(obj: unknown, timestamps: Date[]): void {
 ...
 */
function shiftTimestamps(obj: unknown, timeDifference: number): unknown {
